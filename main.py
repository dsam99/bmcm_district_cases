...
def main():
    districts = [6,10,16,35,91,88,68,77,78,61,62,46] # RI, NY S, Penn Mid, TX S, FL S, ALabama S, SoCal, Wash West, Colorado, ND, SD, Illinois Cent
    ...
    # create df
    # data.process_df(district_num, features, ageframe, crimframe, "dist_88.csv")
    # sys.exit()
    ...
    # with open("10_tv_results.csv", "w") as f:
    #     writer = csv.writer(f)
    #     writer.writerows(tv_results)
    #
    # with open("10_chi_results.csv", "w") as f:
    #     writer = csv.writer(f)
